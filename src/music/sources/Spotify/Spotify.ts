...
export namespace Spotify {
    ...
    export function getTrackNamesFromAlbumSearch(
        query: string
    ): Promise<Album> {
        return new Promise((res, rej) => {
            spotifyApi.clientCredentialsGrant().then((data) => {
    ...
    export function getTrackNamesFromAlbumID(
        albumID: string,
        accessToken?: string
    ): Promise<ExternalTrackInfo[]> {
    ...
    export function getTrackNamesFromPlaylistSearch(
        query: string
    ): Promise<ExternalTrackInfo[]> {
        return new Promise((res, rej) => {
            spotifyApi.clientCredentialsGrant().then((data) => {
...
function convertResponseToSpotifyAlbum(
    album: any,
